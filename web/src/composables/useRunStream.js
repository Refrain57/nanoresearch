...
export function useRunStream() {
  ...
  async function start(runId, { onDelta, onToolHint, onEnd, onToolCall, onMessageComplete, onSubagentResult, onCitations, onAgentMessage } = {}) {
    ...
    try {
      ...
      const dispatch = () => {
        ...
        try {
          ...
          else if (event.type === 'agent_message') onAgentMessage?.(event)
