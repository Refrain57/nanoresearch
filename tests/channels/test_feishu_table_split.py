...
table, allowing nanoresearch to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from nanoresearch.channels import feishu
...
from nanoresearch.channels.feishu import FeishuChannel
