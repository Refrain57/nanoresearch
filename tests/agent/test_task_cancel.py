...
def _make_loop(*, exec_config=None):
    ...
    with patch("nanoresearch.agent.loop.ContextBuilder"), \
         ...
         patch("nanoresearch.agent.loop.SubagentManager") as MockSubMgr:
...
class TestHandleStop:
    ...
    async def test_stop_no_active_task(self):
        ...
        from nanoresearch.command.builtin import cmd_stop
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        from nanoresearch.agent.subagent import SubagentManager
        from nanoresearch.bus.queue import MessageBus
        from nanoresearch.providers.base import LLMResponse, ToolCallRequest
        ...
        monkeypatch.setattr("nanoresearch.agent.tools.registry.ToolRegistry.execute", fake_execute)
