...
from nanoresearch.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from nanoresearch.agent.tools.registry import ToolRegistry
from nanoresearch.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("nanoresearch.agent.tools.mcp.logger.warning", _warning)
