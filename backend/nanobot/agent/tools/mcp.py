...
class MCPToolWrapper(Tool):
    ...
    async def execute(self, **kwargs: Any) -> str:
        ...
        # Auto-inject session_key for tools that need it
        if self._original_name == "retrieve_hybrid":
            ...
            if self._session_key:
                ...
                logger.info(f"MCP tool '{self._name}': injected session_key={self._session_key}")
            else:
                logger.warning(f"MCP tool '{self._name}': no session_key available for injection")
