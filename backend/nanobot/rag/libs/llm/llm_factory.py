...
from nanobot.rag.libs.llm.base_llm import BaseLLM
from nanobot.rag.libs.llm.base_vision_llm import BaseVisionLLM
...
def _register_vision_providers() -> None:
    ...
    """
    try:
        from nanobot.rag.libs.llm.azure_vision_llm import AzureVisionLLM
