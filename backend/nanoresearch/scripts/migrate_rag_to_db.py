...
Usage:
    python -m nanoresearch.scripts.migrate_rag_to_db [--collection default] [--kb-name "默认知识库"] [--uid admin] [--dry-run]
...
async def migrate(
    ...
    # --- init DB ---
    from nanoresearch.storage.database import init_engine, get_session_factory, init_db
