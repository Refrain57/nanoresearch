...
if TYPE_CHECKING:
    from nanoresearch.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    ...
    "X-OpenRouter-Title": "nanoresearch",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply Nanoresearch attribution headers to OpenRouter requests by default."""
