...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install nanoresearch-ai[matrix]"
    ) from e
...
from nanoresearch.config.paths import get_data_dir, get_media_dir
from nanoresearch.config.schema import Base
from nanoresearch.utils.helpers import safe_filename
