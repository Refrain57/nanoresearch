...
- Publish to Nanoresearch bus via BaseChannel._handle_message()
...
def _make_bot_class(channel: QQChannel) -> type[botpy.Client]:
    ...
    class _Bot(botpy.Client):
        def __init__(self):
            # Disable botpy's file log — nanoresearch uses loguru; default "botpy.log" fails on read-only fs
...
class QQConfig(Base):
    ...
    # Optional: directory to save inbound attachments. If empty, use nanoresearch get_media_dir("qq").
    media_dir: str = ""
