...
from nanoresearch.agent.tools.paper_fetch import PaperFetchTool
...
from nanoresearch.agent.tools.spawn import SpawnTool
...
from nanoresearch.command import CommandContext, CommandRouter, register_builtin_commands
...
class AgentLoop:
    ...
    def _register_default_tools(self) -> None:
        ...
        if self._session_factory is not None:
            try:
                from nanoresearch.agent.tools.graph_retrieval import RetrieveByEntityTool
    ...
    async def _connect_mcp(self) -> None:
        ...
        from nanoresearch.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    def _strip_think(text: str | None) -> str | None:
        ...
        if not text:
            return None
        from nanoresearch.utils.helpers import strip_think
