...
from nanoresearch.rag.mcp_server.protocol_handler import create_mcp_server
...
def _preload_heavy_imports() -> None:
    ...
    try:
        import nanoresearch.rag.core.query_engine.query_processor  # noqa: F401
        import nanoresearch.rag.core.query_engine.hybrid_search  # noqa: F401
        import nanoresearch.rag.core.query_engine.dense_retriever  # noqa: F401
        import nanoresearch.rag.core.query_engine.sparse_retriever  # noqa: F401
        import nanoresearch.rag.core.query_engine.reranker  # noqa: F401
        import nanoresearch.rag.ingestion.storage.bm25_indexer  # noqa: F401
        import nanoresearch.rag.libs.embedding.embedding_factory  # noqa: F401
        import nanoresearch.rag.libs.vector_store.vector_store_factory  # noqa: F401
    except ImportError:
        pass
...
def main() -> int:
    ...
    Supports --config argument to specify settings file:
        python -m nanoresearch.rag.mcp_server --config /path/to/settings.yaml
    """
    import argparse as _argparse

    _parser = _argparse.ArgumentParser(description="Modular RAG MCP Server")
    ...
    if _args.config:
        import os as _os
        _os.environ["RAG_SETTINGS_PATH"] = _args.config
