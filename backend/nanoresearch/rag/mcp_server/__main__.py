...
Run with: python -m nanoresearch.rag.mcp_server
       or: python -m nanoresearch.rag.mcp_server --config /path/to/settings.yaml
"""
import argparse
import sys

from nanoresearch.rag.mcp_server.server import run_stdio_server
