...
from nanoresearch.rag.core.session import FileSessionStore, MemorySessionStore
from nanoresearch.rag.core.types_agentic import SearchSession
...
class SessionManager:
    ...
    def _init_store(self) -> None:
        ...
        try:
            from nanoresearch.rag.core.settings import get_settings, resolve_path
