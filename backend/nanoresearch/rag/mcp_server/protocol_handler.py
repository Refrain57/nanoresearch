...
def _register_default_tools(protocol_handler: ProtocolHandler) -> None:
    ...
    from nanoresearch.rag.mcp_server.tools.rag_search import register_tools as register_kb_search_tools
    register_kb_search_tools(protocol_handler)

    # Register kb_retrieve + memory_search - direct retrieval tools
    from nanoresearch.rag.mcp_server.tools.agentic.retrieval import register_tools as register_retrieval_tools
    register_retrieval_tools(protocol_handler)

    # Register collection management tools
    from nanoresearch.rag.mcp_server.tools.agentic.collections import register_tools as register_collection_tools
