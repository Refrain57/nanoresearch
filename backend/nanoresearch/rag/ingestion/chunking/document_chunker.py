...
from nanoresearch.rag.core.types import Chunk, Document
from nanoresearch.rag.libs.splitter.splitter_factory import SplitterFactory
...
class DocumentChunker:
    ...
    def _get_semantic_chunker(self):
        ...
        if not hasattr(self, "_semantic_chunker") or self._semantic_chunker is None:
            from nanoresearch.rag.ingestion.chunking.semantic_chunker import SemanticChunker
...
class StructuredChunker:
    ...
    def split_text(self, text: str) -> list[str]:
        from nanoresearch.rag.libs.splitter.ragflow.book import chunk_markdown
