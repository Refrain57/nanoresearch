...
from nanoresearch.rag.libs.reranker.base_reranker import BaseReranker, NoneReranker
...
def _lazy_import_llm_reranker():
    ...
    from nanoresearch.rag.libs.reranker.llm_reranker import LLMReranker
    return LLMReranker


def _lazy_import_cross_encoder_reranker():
    """Lazy import to avoid circular dependencies."""
    from nanoresearch.rag.libs.reranker.cross_encoder_reranker import CrossEncoderReranker
