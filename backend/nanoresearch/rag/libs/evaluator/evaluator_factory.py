...
def _get_ragas_evaluator() -> type[BaseEvaluator]:
    ...
    from nanoresearch.rag.observability.evaluation.ragas_evaluator import RagasEvaluator
    return RagasEvaluator


def _get_composite_evaluator() -> type[BaseEvaluator]:
    """Lazy import CompositeEvaluator."""
    from nanoresearch.rag.observability.evaluation.composite_evaluator import CompositeEvaluator
