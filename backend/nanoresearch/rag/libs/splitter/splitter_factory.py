...
def _register_builtin_providers() -> None:
    ...
    try:
        from nanoresearch.rag.libs.splitter.recursive_splitter import RecursiveSplitter
    ...
    try:
        from nanoresearch.rag.ingestion.chunking.document_chunker import StructuredChunker
