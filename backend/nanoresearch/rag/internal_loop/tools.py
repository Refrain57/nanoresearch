...
from nanoresearch.rag.internal_loop.state import RoundState, SessionState, SubQuery
...
def _get_plan_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.query_planning import PlanQueryTool
    return PlanQueryTool

def _get_verify_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.verification import VerifyResultsTool
    return VerifyResultsTool

def _get_rerank_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.reranking import RerankResultsTool
    return RerankResultsTool

def _get_citations_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.citations import BuildCitationsTool
...
def _get_fetch_section_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.retrieval import get_fetch_section_tool
    return get_fetch_section_tool()

def _get_fetch_neighbors_tool():
    from nanoresearch.rag.mcp_server.tools.agentic.retrieval import get_fetch_neighbors_tool
