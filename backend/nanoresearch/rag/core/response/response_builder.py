"""Response Builder for constructing formatted responses.

This module builds structured responses for tools, combining:
...
from nanoresearch.rag.core.response.citation_generator import Citation, CitationGenerator
...
# Mock MCP types for compatibility
...
class MCPToolResponse:
    ...
    Attributes:
        ...
        image_contents: List of ImageContent blocks for multimodal responses
    """
    content: str
    ...
    def to_mcp_content(self) -> List[Any]:
        ...
        if not HAS_MCP_TYPES:
            # Fallback: return plain dict format
...
class ResponseBuilder:
    ...
    def multimodal_assembler(self) -> "MultimodalAssembler":
        ...
        if self._multimodal_assembler is None:
            from nanoresearch.rag.core.response.multimodal_assembler import MultimodalAssembler
    ...
    def build(
        ...
        if self.enable_multimodal and include_images:
            ...
            image_contents = [
                ...
                if HAS_MCP_TYPES and isinstance(block, mcp_types.ImageContent)
            ]
            if image_contents:
