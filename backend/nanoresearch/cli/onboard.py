"""Interactive onboarding questionnaire for nanoresearch."""
...
from nanoresearch.cli.models import (
    format_token_count,
...
def _show_main_menu_header() -> None:
    ...
    from nanoresearch import __logo__, __version__
    ...
    console.print(
        Align.center(f"{__logo__} [bold cyan]nanoresearch[{__version__}][/bold cyan]")
    )
    console.print()
...
def _try_auto_fill_context_window(model: BaseModel, new_model_name: str) -> None:
    ...
    Note:
        This function imports AgentDefaults from nanoresearch.config.schema to get
    ...
    from nanoresearch.config.schema import AgentDefaults
