...
```bash
python $(dirname $(which nanobot))/../skills/github-deep-research/scripts/github_api.py <owner> <repo> summary
python $(dirname $(which nanobot))/../skills/github-deep-research/scripts/github_api.py <owner> <repo> readme
python $(dirname $(which nanobot))/../skills/github-deep-research/scripts/github_api.py <owner> <repo> tree
```
