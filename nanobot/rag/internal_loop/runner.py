...
class RAGLoopRunner:
    ...
    def session_manager(self):
        ...
        if self._session_manager is None:
            from nanobot.rag.internal_loop.state import SessionStateManager
    ...
    async def run(
        ...
        from nanobot.rag.internal_loop.state import SessionState
        ...
        # Import prompts
        from nanobot.rag.internal_loop.prompts import build_system_prompt, build_task_instruction
        from nanobot.rag.internal_loop.cleanup import cleanup_messages_for_next_round
        ...
        try:
            ...
            for iteration in range(max_iterations):
                ...
                if next_actions:
                    ...
                    from nanobot.rag.internal_loop.state import SubQuery
    ...
    async def _run_plan_phase(
        ...
        """Run Phase 1: Plan."""
        # Import here
        from nanobot.rag.internal_loop.state import PlanResult, SubQuery
