...
from nanobot.rag.ingestion.storage.vector_upserter import VectorUpserter
...
def _infer_domain(file_path: str, text: str) -> str:
    ...
    Returns:
        Domain string: "papers", "nanobot", "notes", or "general"
    """
    ...
    path_rules = [
        ...
        ("nanobot", "ragr", "logr", "mcp", "rag", "agent", "ingestion"),
    ]

    for domain, keywords in [("papers", path_rules[0]), ("nanobot", path_rules[1])]:
