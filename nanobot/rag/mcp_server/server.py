...
from nanobot.rag.mcp_server.protocol_handler import create_mcp_server
...
def _preload_heavy_imports() -> None:
    ...
    try:
        import nanobot.rag.core.query_engine.query_processor  # noqa: F401
        import nanobot.rag.core.query_engine.hybrid_search  # noqa: F401
        import nanobot.rag.core.query_engine.dense_retriever  # noqa: F401
        import nanobot.rag.core.query_engine.sparse_retriever  # noqa: F401
        import nanobot.rag.core.query_engine.reranker  # noqa: F401
        import nanobot.rag.ingestion.storage.bm25_indexer  # noqa: F401
        import nanobot.rag.libs.embedding.embedding_factory  # noqa: F401
        import nanobot.rag.libs.vector_store.vector_store_factory  # noqa: F401
    except ImportError:
        pass
...
def main() -> int:
    ...
    Supports --config argument to specify settings file:
        python -m nanobot.rag.mcp_server --config /path/to/settings.yaml
    """
